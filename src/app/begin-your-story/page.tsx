...
export default function BeginYourStory() {
  ...
  const consultationTypes = [
    ...
    {
      id: 'deep-dive',
      title: '60-Minute Creative Deep-Dive',
      subtitle: 'Free',
    ...
    {
      id: 'in-person',
      title: '90-Minute In-Person Meeting',
      subtitle: '₹500 (refundable with booking)',
      ...
      <section className="py-20 bg-luxury-accent">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <p className="font-primary text-lg text-luxury-primary/70 max-w-2xl mx-auto">
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="font-primary-bold text-xl text-luxury-primary">
                        {consultation.title}
                      </h3>
                      {consultation.popular && (
                        <span className="bg-luxury-primary text-white px-2 py-1 rounded text-xs font-primary-medium">
                          Most Popular
                        </span>
                      )}
                    </div>
                    <p className="font-primary text-base text-luxury-primary/80 mb-2">
                      {consultation.description}
                    </p>
                    <p className="font-primary-medium text-sm text-luxury-primary/60">
                      {consultation.subtitle}
                    </p>
                  </div>
                  <div className="text-right">
                    <span className="font-primary-medium text-sm text-luxury-primary">
          ...
          <AnimatePresence>
            {selectedConsultation && (
              ...
              >
                <motion.button 
                  className="bg-luxury-primary hover:bg-luxury-primary/90 text-white px-8 py-3 font-primary-medium text-sm tracking-wider uppercase transition-all duration-300 rounded-md shadow-lg hover:shadow-xl"

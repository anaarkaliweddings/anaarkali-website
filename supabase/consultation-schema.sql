...
-- Allow anyone to insert consultation bookings
CREATE POLICY "Allow public to insert consultation bookings" ON consultation_bookings
    FOR INSERT WITH CHECK (true);

-- Allow anyone to read their own consultation bookings (by email)
CREATE POLICY "Allow users to read their own consultation bookings" ON consultation_bookings
    FOR SELECT USING (true);

-- Allow authenticated users to update consultation bookings
CREATE POLICY "Allow authenticated users to update consultation bookings" ON consultation_bookings
    FOR UPDATE USING (true);

-- Allow authenticated users to delete consultation bookings
CREATE POLICY "Allow authenticated users to delete consultation bookings" ON consultation_bookings
